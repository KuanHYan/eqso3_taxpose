# sh train_base_model_on_local_docker_debug.sh "0,1" 2 True debug_distributed_training
GPU_INDEX=$1
GPU_NUM=$2
TEST_MODE=$3
WANDB_NAME=$4
...
bash "./my_launch.sh" local-docker $GPU_INDEX \
    ...
    dm.train_dset.dataset_size=10000 \
