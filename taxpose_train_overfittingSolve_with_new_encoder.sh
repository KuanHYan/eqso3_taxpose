...
bash "./launch.sh" local $GPU_INDEX \
    ...
    model.pretraining.action.ckpt_path="${ROOT_DIR}logs/pretrain_embedding/2026-05-01/18-27-52/checkpoints/last.ckpt" \
    model.pretraining.anchor.ckpt_path="${ROOT_DIR}logs/pretrain_embedding/2026-05-01/18-27-52/checkpoints/last.ckpt" \
    wandb.offline=False \
    debug=False \
