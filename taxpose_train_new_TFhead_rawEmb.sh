...
bash "./my_launch.sh" local $GPU_INDEX \
    ...
    dm.train_dset.demo_dset.occlusion_cfg.random_dropout=True \
    dm.train_dset.demo_dset.occlusion_cfg.anisotropic_scaling=True \
    dm.train_dset.demo_dset.occlusion_cfg.gaussian_noise=True \
